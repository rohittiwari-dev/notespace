# NoteSpace's contributing guidelines
...
Our preferred way of providing the opportunity for people to contribute to NoteSpace is through a process that starts with creating a new issue, the summary of the workflow that you can expect and should adhere to is the following:
...
- We will review the pull request and if all is good, congratulations! 🥳 you are now a NoteSpace contributor!
- If not, we will explain the changes that need to be made for the pull request to be merged or why it can't be merged.

If you would like to be more involved in the development of NoteSpace, we would like to invite you to our [Discord Server](https://discord.gg/SERySfj8Eg) where we can have a chat together and get you involved in the project!
...
- Be nice to everyone involved, we are aiming to create a positive community around collaborating and contributing towards NoteSpace's development.
...
Bun is used as the package manager of NoteSpace, with Bun, you don't need to have NodeJS installed at all on your system to be able to run NoteSpace. The only tool you need to install dependencies & run NoteSpace is Bun!
...
With bun installed on your machine, the next step would be to install the dependencies that NoteSpace relies upon to work, to do this, run the following command:
...
Again, thank you so much for your interest in contributing to NoteSpace, we really appreciate it, and if there is anything we can do to help your journey, make sure to join our [Discord Server](https://discord.gg/SERySfj8Eg).
