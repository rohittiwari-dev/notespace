...
const SigningPage: React.FC<Props> = ({ searchParams }) => {
	...
	return (
		<main className="container-main z-0 flex h-full w-full flex-col items-center justify-center">
			<Card className="min-w-[min(400px,90%)] rounded-xl border-none bg-transparent bg-none shadow-none backdrop-blur-xl">
