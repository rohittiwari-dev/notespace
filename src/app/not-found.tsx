...
export default function NotFoundPage() {
	return (
		<main className="bg-background relative h-full w-full">
			<div className="dark:to-secondary-950 absolute top-0 left-0 z-0 h-56 w-full bg-gradient-to-b from-transparent to-transparent opacity-70 dark:from-indigo-950" />
