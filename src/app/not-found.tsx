...
export default function NotFoundPage() {
	return (
		<main className="bg-background relative">
			<div className="to-secondary-950 absolute top-0 left-0 z-0 h-56 w-full bg-gradient-to-b from-indigo-950 opacity-70" />
				...
				<div className="container-main flex flex-1">
					<main className="mb-4 flex flex-1 flex-col items-center justify-center gap-6">
						...
						<p className="max-w-prose text-center text-lg text-balance text-slate-400">
							It looks like this page has gone on an adventure.
							Maybe it&apos;s hanging out with all those missing
