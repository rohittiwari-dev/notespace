	...
	"inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
	{
		variants: {
			variant: {
				...
				link: "relative bg-gradient-to-br from-primary left-0 ring-offset-1 to-purple-400 bg-clip-text text-transparent before:absolute before:bottom-0 before:h-px before:w-[calc(100%-2.7rem)] before:right-8 before:rounded-full before:bg-gradient-to-br before:from-secondary-500 before:to-purple-400 hover:opacity-90",
			},
			size: {
				default: "px-4 py-2",
				sm: "px-3 py-1.5",
