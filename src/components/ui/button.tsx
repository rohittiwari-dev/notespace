...
const buttonVariants = cva(
	"inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
	{
		variants: {
			variant: {
				default:
					" whitespace-nowrap bg-primary text-lg text-primary-foreground hover:bg-indigo-600/70 shadow-2xl shadow-indigo-600/50 rounded-lg ",
				destructive:
				...
				"btn-secondary":
					"whitespace-nowrap dark:text-primary-foreground text-lg font-normal bg-primary hover:!text-white hover:bg-washed-blue-700/90",
			},
			size: {
